...
import { ChevronDownIcon, BellAlertIcon, MagnifyingGlassIcon, Bars3Icon, MoonIcon } from "@heroicons/react/24/outline";
  ...
  return (
    <div className="flex items-center justify-between bg-white dark:bg-slate-700 border-b shadow-sm lg:px-8 px-4">
      ...
      <div className="flex items-center justify-end w-full">
        ...
        <figure className="w-9 h-9 mx-4 rounded-full overflow-hidden flex-shrink-0">
          <img src={userImg} alt="user" />
        </figure>

        <div className="flex items-center">
          <span className=" pr-3 font-semibold text-sm text-gray-700 dark:text-white">
            Tom Cook
          </span>
          <ChevronDownIcon className="size-4 text-gray-400 transition duration-150 hover:rotate-180 hover:text-gray-600 dark:text-white dark:hover:dark:text-white" />
        </div>
      </div>
    </div>
  );
